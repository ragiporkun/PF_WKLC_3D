...
@jax.jit
def one_step(phase, dT, P9, Pfunc, t, x_center):
    cond1 = (t > 0.0) & (t < 0.500)
    ...
    t = t + dt
    return phase, dT, P9, Pfunc, t, x_center
...
for step in range(1, steps + 1):
    phase, dT, P9, Pfunc, t, x_center = one_step(phase, dT, P9, Pfunc, t, x_center)
    ...
    if (step % plot_every) == 0 or step == steps:
        ...
        print(f"Saved VTK at t = {float(t):.6f} to {vtk_filename}")
