...
def main():
    ...
    # ----------------------------------------------------------
    # Slice selection (NEW): restrict to a single plane
    # ----------------------------------------------------------
    ...
    # Build a suffix for filenames so slice outputs don't overwrite full-domain ones
    if args.slice is not None:
